...
function Wallet() {
  ...
  let frequent;
    ...
    const {connectors, connect, status, errors} = useConnect();
              ...
              <Row className="w-full">
                ...
                <Col xs={{span:24}} md={{span:14}} className="bg-white border-l-8 border-gray-200 p-4 ">
                  ...
                  <Row className="mt-2  text-center">
                    ...
                    <div class="ant-col ant-col-24 text-center mt-4">

                    {connectors.map((connector) =>
                                                           
                                                                    <button
                                                                        key={connector.uid}
                                                                        className="iekbcc0 ml-4 iekbcc9 ju367v89 ju367v6i ju367v73 ju367v7o ju367vo ju367vt ju367vv ju367v8u ju367v9f ju367vb1 g5kl0l0 _12cbo8i3 ju367v8r _12cbo8i6"
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <div
                                                                            className="iekbcc0 ju367vgu ju367v16 ju367v1a ju367v1h ju367v8u">
                                                                            <div
                                                                                className="iekbcc0 ju367v4 ju367va ju367v14 ju367v1s">
                                                                                <div
                                                                                    className="iekbcc0 ju367vj ju367v2b ju367v6c ju367v8r ju367v94"
                                                                                    role="img"
                                                                                >
                                                                           
                                                                                    <img
                                                                                        className="iekbcc0 ju367v2m ju367v8p ju367v9f"
                                                                                        aria-hidden="true"
                                                                                        src={connector.icon}
                                                                                        style={{
                                                                                            transition:
                                                                                ...
                                                                                <div className="iekbcc0">
                                                                                    <div
                                                                                        className="iekbcc0 ju367v5p"
                                                                                        style={{marginTop: "-2px"}}
                                                                                    >
                                                                                        {connector.name}
                                                                                    </div>
                                                                                    {/* <div
                                                                                        className="iekbcc0 ju367vf0 ju367v16 ju367v17 ju367v1f ju367v2v"
                                                                                        style={{
                                                                                            lineHeight: 1,
                                                                                            marginTop: "-1px",
                                                                                        }}
                      ...
                      {/* <Button className="mx-3 myButton  myBule text-white px-5 text-sm" >Connect Wallet</Button> */}
                      </div>
                  </Row>
